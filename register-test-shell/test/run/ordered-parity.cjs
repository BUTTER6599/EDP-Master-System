// DERIVED FROM test/recovery-snapshot/ordered-parity.cjs — DO NOT EDIT THE SNAPSHOT.
...
// logic and every assertion are otherwise byte-identical. Ordered-parity analysis (83/99 accepted finding).
